...
//connect to database.
$id=$_POST['message_report'];
$fname="";
$lname="";
$count="";
$sql =mysql_query("SELECT * FROM private_messages WHERE id_from=$id");
...
while($row = mysql_fetch_array($sql)) 
{
        ...
        $data[] = array($name,$lname, $row['subject'], $row['message'],$row['time_sent']);
...
$header=array('Name','Last Name','Subject','Message', 'Date');
